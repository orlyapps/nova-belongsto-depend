  ...
  computed: {
    ...
    creatingViaRelatedResource() {
      return (
        ...
        typeof this.viaResourceId !== "undefined"
      );
    },
    ...
    if (this.field.dependsOn) {
      Nova.$on(
        ...
        async (dependsOnValue) => {
          ...
          Nova.$emit(
            "nova-belongsto-depend-" + this.field.attribute.toLowerCase(),
            {
              value: this.value,
              field: this.field,
            }
  ...
  methods: {
    ...
    setInitialValue() {
      ...
      if (this.field.value) {
        ...
        this.value = this.options.find(
          (item) => item[this.field.modelPrimaryKey] == this.viaResourceId
        );
      }
    ...
    fill(formData) {
      if (this.value) {
        ...
        if (this.field.fallback) {
          formData.append(
            this.field.fallback.attribute,
            this.$refs["field-" + this.field.fallback.attribute].value
          );
        } else {

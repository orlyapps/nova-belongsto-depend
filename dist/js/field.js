...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-belongsto-depend', __webpack_require__(5));
    Vue.component('detail-nova-belongsto-depend', __webpack_require__(8));
    Vue.component('form-nova-belongsto-depend', __webpack_require__(11));
});
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    Nova.$emit("nova-belongsto-depend-" + _this.field.attribute.toLowerCase(), {
                                        value: _this.value,
                                        field: _this.field
                                    });
    ...
    methods: {
        ...
        setInitialValue: function setInitialValue() {
            ...
            if (this.field.value) {
                ...
                this.value = this.options.find(function (item) {
                    return item[_this2.field.modelPrimaryKey] == _this2.viaResourceId;
                });
            }

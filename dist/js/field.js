...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-belongsto-depend', __webpack_require__(3));
    Vue.component('detail-nova-belongsto-depend', __webpack_require__(6));
    Vue.component('form-nova-belongsto-depend', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_multiselect__ = __webpack_require__(25);
                            ...
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    return Nova.request().post("/nova-vendor/nova-belongsto-depend", {
                                        resourceClass: _this.field.resourceParentClass,
                                ...
                                case 5:
                                    _this.options = _context.sent.data;


                                    if (_this.field.valueKey) {
                                        _this.value = _this.options.find(function (item) {
                                            return item[_this.field.modelKeyName] == _this.field.valueKey;
                                        });
                                        Nova.$emit("nova-belongsto-depend-" + _this.field.attribute, {
                                            value: _this.value,
                                            field: _this.field
        ...
        setInitialValue: function setInitialValue() {
            ...
            if (this.field.value) {
                this.value = this.options.find(function (item) {
                    return item[_this2.field.modelKeyName] == _this2.field.valueKey;
                });
...
var update = __webpack_require__(20)("73287042", content, false, {});
